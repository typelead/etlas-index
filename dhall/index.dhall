...
let pkg
    : Text → List Text → List Text → Text → types.IndexedPackage
    =   λ(name : Text)
      → λ(versions : List Text)
      → λ(preferred : List Text)
      → λ(lastest : Text)
      → { name =
            name
        , versions =
...
in  { dhall-eta =
    ...
    , attoparsec =
        pkg "attoparsec" empty [ "0.13.2.0", "0.13.2.1", "0.13.2.2" ] "0.13.2.2"
    , avro =
        pkg "avro" empty [ "0.3.2.0" ] "0.3.2.0"
    , base-compat =
        pkg "base-compat" empty [ "0.10.1", "0.10.4", "0.9.1", "0.9.3" ] "0.9.3"
    , base-orphans =
    ...
    , dhall =
        ...
        "dhall"
        empty
        [ "1.16.1", "1.17.0", "1.18.0", "1.19.0", "1.19.1", "1.20.0", "1.20.1" ]
        "1.20.1"
    , dhall-json =
        pkg "dhall-json" empty [ "1.2.1", "1.2.4", "1.2.5", "1.2.6" ] "1.2.6"
    , digest =
    ...
    , hashtables =
        ...
        "hashtables"
        empty
        [ "1.2.1.0", "1.2.1.1", "1.2.2.0", "1.2.2.1", "1.2.3.0", "1.2.3.1" ]
        "1.2.3.1"
    , haskeline =
    ...
    , http-api-data =
        pkg "http-api-data" empty [ "0.3.5", "0.3.7", "0.3.7.1" ] "0.3.7.1"
    , http-client =
        pkg
        "http-client"
        empty
    ...
    , lens =
        ...
        "lens"
        empty
        [ "4.15.1", "4.15.2", "4.15.3", "4.15.4", "4.16", "4.16.1", "4.17" ]
        "4.17"
    , lens-aeson =
    ...
    , network-uri =
        pkg "network-uri" empty [ "2.6.0.2", "2.6.0.3", "2.6.1.0" ] "2.6.1.0"
    , old-time =
    ...
    , primitive =
        pkg "primitive" empty [ "0.6.1.0", "0.6.2.0", "0.6.4.0" ] "0.6.4.0"
    , process =
    ...
    , scientific =
        pkg "scientific" empty [ "0.3.4.9", "0.3.5.0", "0.3.5.1" ] "0.3.5.1"
    , semigroupoids =
        pkg
        "semigroupoids"
        empty
    ...
    , time =
        ...
        "time"
        empty
        [ "1.6.0.1", "1.7", "1.7.0.1", "1.8", "1.8.0.1", "1.8.0.2", "1.8.0.3" ]
        "1.8.0.3"
    , transformers =
    ...
    , vector =
        pkg "vector" empty [ "0.11.0.0", "0.12.0.0", "0.12.0.1" ] "0.12.0.1"
    , vector-th-unbox =
